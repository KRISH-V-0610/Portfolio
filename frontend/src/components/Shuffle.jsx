    ...
    () => {
      ...
      const build = () => {
        ...
        chars.forEach(ch => {
          ...
          let initialColor = colorFrom;
          if (typeof initialColor === 'function') initialColor = initialColor();
          if (initialColor) inner.style.color = initialColor;
      ...
      const play = () => {
        ...
        const addTween = (targets, at) => {
          ...
          if (colorFrom && colorTo) {
            let cFrom = colorFrom;
            if (typeof cFrom === 'function') cFrom = cFrom();
            tl.fromTo(targets, { color: cFrom }, { color: colorTo, duration, ease }, at);
          }
        };
        ...
        if (animationMode === 'evenodd') {
          ...
          strips.forEach(strip => {
            ...
            if (colorFrom && colorTo) {
              let cFrom = colorFrom;
              if (typeof cFrom === 'function') cFrom = cFrom();
              tl.fromTo(strip, { color: cFrom }, { color: colorTo, duration, ease }, d);
            }
          });
        }
